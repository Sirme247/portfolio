...
const images = [
    { src: 'screenshots/dash-mindmate.jpeg', title: 'Home Screen' },
    { src: 'screenshots/courses.jpeg', title: 'Courses' },
    { src: 'screenshots/tutors.jpeg', title: 'Tutors' },
    { src: 'screenshots/chats-mindmate.jpeg', title: 'Chat Interface' },
    { src: 'screenshots/forum.jpeg', title: 'Forum' }
];
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    roleCards.forEach(card => cardsObserver.observe(card));
});
...
// Add parallax effect on scroll for hero section
...
// Add smooth entrance animation to back button
